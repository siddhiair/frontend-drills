...
const Card = ({ result }: { result: Challenge }) => {
  ...
  return (
    <div className="sm:w-1/2 xl:w-1/3 px-4">
      <div className="card p-5 border-gray-300 border rounded-lg transition-shadow hover:shadow-md h-full sm:flex flex-col">
        <div className="grow">
